  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <section id="contact" className="bg-gray-50 px-6 py-16 text-center">
        ...
        <p className="text-gray-700 mb-2 flex justify-center items-center gap-2"><Mail className="w-5 h-5" /> contact@threecapital.be</p>
        <p className="text-gray-700 mb-2 flex justify-center items-center gap-2"><Phone className="w-5 h-5" /> +32 485 00 00 00</p>
